...
import android.database.Cursor;
import android.database.sqlite.SQLiteDatabase;
public class Viewamb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewamb);





        vb11 = (Button) findViewById(R.id.button3);
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(res.getCount() == 0) {
                            ...
                            Toast.makeText(Viewamb.this,"Nothing Found", Toast.LENGTH_LONG).show();
                            return;
                        }
