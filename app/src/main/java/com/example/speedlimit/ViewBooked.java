...
public class ViewBooked extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vb11 = (Button) findViewById(R.id.vb1);
        vb111 = (Button) findViewById(R.id.button5);

        loc1 = (EditText) findViewById(R.id.viewb);
        sqLiteHelper = new SQLiteHelper(this);
        viewAll();
        vb111.setOnClickListener(new View.OnClickListener() {

            public void onClick(View view) {

                // Opening new user registration activity using intent on button click.
                Intent intent = new Intent(ViewBooked.this, MainActivity.class);
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(res.getCount() == 0) {
                            ...
                            Toast.makeText(ViewBooked.this,"Nothing Found", Toast.LENGTH_LONG).show();
                            return;
                        }

                        StringBuffer buffer = new StringBuffer();
                        buffer.append( "AmbNo  "  + " Status "+"\n" );
                        while (res.moveToNext()) {



                            buffer.append( res.getString(0)  + "            " + res.getString(8) +"\n" );
